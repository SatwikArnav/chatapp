...
const Topbar = ({ startVideoCall }) => {
  ...
  return (
    <div className="flex items-center justify-between px-3 py-2 bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 text-white h-16 w-full fixed top-0 z-10 shadow-md">
